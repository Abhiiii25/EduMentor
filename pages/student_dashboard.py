...
if predicted_class == 1:
    send_email_alert(
        to_email="abhigaikwad089@gmail.com",  # Replace with actual teacher email
...
st.markdown(f"**Predicted Risk Status:** <span style='color:{risk_color}; font-weight:bold'>{risk_label}</span>", unsafe_allow_html=True)
st.markdown(f"**Predicted Risk Score:** <span style='color:{risk_color}; font-weight:bold'>{predicted_score:.2f}</span>", unsafe_allow_html=True)
